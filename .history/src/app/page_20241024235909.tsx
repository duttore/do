...
import { faBars, faWhatsapp } from '@fortawesome/free-brands-svg-icons';
...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-[#f8f9fa] text-[#343a40]">
      <NextSeo
        title="Home | Stefano Ricci"
        description="Assistenza professionale per macchine da cucire."
      />
      ...
      <section id="contatti" className="py-16">
        <div className="container mx-auto text-center">
          ...
          <div className="text-lg font-bold mt-6">
            ...
            <span>Telefono: <span className="text-[#343a40]">+39 334 315 6903</span></span>
          </div>
        </div>
      </section>
