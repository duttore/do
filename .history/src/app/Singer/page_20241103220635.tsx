    ...
    <div className="font-sans bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900">
      ...
      <main className="container mx-auto p-4 pt-24">
        ...
        <section className="my-8">
          ...
          <div className="my-4">
            <Image
              src="https://upload.wikimedia.org/wikipedia/commons/0/0f/Early_20th-century_Singer_sewing_machine_in_Malta.png"
        ...
        <section className="my-8">
          ...
          <div className="my-4">
            <Image
              src="https://www.singer.com/cdn/shop/files/SINGER_Sewing_Camp_1280x1280_1f41bb3a-badd-40f4-8a02-8991ce9b1d66.jpg?v=1727367660&width=640"
        ...
        <section className="my-8">
          ...
          <div className="my-4">
            <Image
              src="https://www.singer.com/cdn/shop/files/Singer-Inspiration-Project-1.jpg?v=1708467328&width=640g"
        ...
        <section className="my-8">
          ...
          <div className="my-4">
            <Image
              src="https://www.singer.com/cdn/shop/files/Singer-Inspiration-Project-2.jpg?v=1708467372&width=640"
        ...
        <section className="my-8">
          ...
          <div className="my-4">
            <Image
              src="https://www.singer.com/cdn/shop/files/SINGER_Inspiration_1280x1280_139f358f-0ce1-4b5e-97b6-448c7f3b36ec.jpg?v=1726257076&width=640"
