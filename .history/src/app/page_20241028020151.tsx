      ...
      <div className="mt-2 sm:mt-4 flex gap-2 overflow-x-auto pb-2 snap-x">
        {mediaItems.map((item, index) => (
          <button
            ...
            className={`relative flex-shrink-0 rounded-lg overflow-hidden snap-start ${
          ...
          >
            <Image
              ...
              sizes="(max-width: 640px) 60px, (min-width: 641px) 80px, (min-width: 1024px) 100px" // Tailored sizes
            />
            {item.type === 'video' && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/30">
                <FontAwesomeIcon icon={faPlay} className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
              </div>
            )}
          </button>
        ))}
