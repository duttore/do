...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-[#fbfcff] text-[#605856]">
      {/* Header */}
      <header className="bg-[#1c6e8c] py-4 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 text-white text-lg">
            <a href="#servizi" className="hover:text-[#d0ccd0] transition duration-300">Servizi</a>
            <a href="#chi-sono" className="hover:text-[#d0ccd0] transition duration-300">Chi Sono</a>
            <a href="#contatti" className="hover:text-[#d0ccd0] transition duration-300">Contatti</a>
          </nav>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden bg-[#1c6e8c] text-white text-lg py-4">
            <a href="#servizi" className="block py-2 px-4 hover:bg-[#274156]">Servizi</a>
            <a href="#chi-sono" className="block py-2 px-4 hover:bg-[#274156]">Chi Sono</a>
            <a href="#contatti" className="block py-2 px-4 hover:bg-[#274156]">Contatti</a>
          </div>
        )}
      </header>

      {/* Hero Section */}
      <section className="hero relative py-32 text-center text-white bg-[#1c6e8c]">
        <Image 
        ...
        <div className="container mx-auto relative z-10">
          ...
          <a href="#servizi" className="mt-6 inline-block bg-[#d0ccd0] text-[#605856] py-3 px-8 rounded-full hover:bg-[#e3c7d0] transition duration-300 shadow-lg">
            Scopri i servizi
          </a>
        </div>
      </section>
      ...
      {/* Servizi Section */}
      <section id="servizi" className="py-16 bg-[#fbfcff]">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-10 text-[#605856]">I miei servizi</h2>
          <div className="flex justify-between space-x-6">
            {['Riparazioni', 'Manutenzione', 'Consulenza'].map((service, index) => (
              <div key={index} className="bg-white p-8 shadow-lg rounded-lg text-center transform hover:scale-105 transition duration-300">
                <h3 className="text-xl font-semibold mb-4 text-[#605856]">{service}</h3>
      ...
      <section id="testimonials" className="py-16 bg-[#605856] text-white">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className={`bg-[#${index === 0 ? 'd0ccd0' : index === 1 ? 'fbfcff' : '1c6e8c'}] p-6 rounded-lg shadow-lg`}>
      ...
      <section id="contatti" className="py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-10 text-[#605856]">Contattami</h2>
      ...
      {/* Footer */}
      <footer className="bg-[#1c6e8c] py-6">
