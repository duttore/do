...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900">
      ...
      <motion.div
        initial={{ y: -100 }}
        animate={{ y: scrollDirection === 'down' && scrolled ? 0 : -100 }}
      ...
      {/* Services, Testimonials, and Contact sections are below */}
      {/* ... You can continue adding other sections similarly as shown above */}
