...
import WhatsApp from '@components/WhatsApp'; // Ensure this import path is correct based on your project structure
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`md:hidden p-2 rounded-lg ${scrolled ? 'text-gray-
