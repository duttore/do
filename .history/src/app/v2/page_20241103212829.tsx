...
import WhatsApp from '@components/WhatsApp'; // Replace this path with the correct one if necessary

// Ensure all icons and components are correctly imported and used as React components.
