...
import { NextSeo } from 'next-seo'; // Import NextSeo for SEO integration
...
export default function Home() {
  ...
  return (
    <>
      {/* SEO Configuration */}
      <NextSeo
        title="Stefano Ricci - Assistenza per Macchine da Cucire a Firenze"
        description="Offriamo riparazioni, manutenzione e consulenza per macchine da cucire a Firenze. Contattaci per un servizio professionale."
        canonical="https://www.stefanoricci.com/"
        openGraph={{
          url: 'https://www.stefanoricci.com/',
          title: 'Stefano Ricci - Assistenza per Macchine da Cucire a Firenze',
          description: 'Riparazioni e manutenzione di macchine da cucire a Firenze. Contattaci per un servizio professionale.',
          images: [
            {
              url: 'https://milanimacchinepercucire.com/wp-content/uploads/2024/02/milani_shop_desio-1024x575.webp',
              width: 1024,
              height: 575,
              alt: 'Macchine da Cucire Firenze',
              type: 'image/webp',
            },
          ],
        ...
        additionalMetaTags={[
          {
            property: 'fb:app_id',
            content: 'YOUR_FACEBOOK_APP_ID', // Replace with actual Facebook App ID
          },
        ]}
      />
      ...
      <div className="font-sans bg-[#f8f9fa] text-[#343a40]">
        ...
        <section className="py-16 text-center">
          <a href="https://wa.me/YOUR_WHATSAPP_NUMBER" target="_blank" rel="noopener noreferrer">
            <button style={{ padding: "10px 20px", backgroundColor: "#25D366", color: "#fff", border: "none", borderRadius: "5px" }}>
