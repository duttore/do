...
const ServiceCard = ({ icon: Icon, title, description }) => (
  <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm">
    <CardContent className="pt-6">
      ...
      <CardTitle className="text-xl mb-4 text-center">{title}</CardTitle>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              L'Arte del Cucito<br />Rinnovata
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "3000+", label: "Clienti Soddisfatti" },
              { number: "30+", label: "Anni di Esperienza" },
              { number: "5000+", label: "Riparazioni Completate" },
