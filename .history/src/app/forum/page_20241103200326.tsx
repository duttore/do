...
import {
  faBars, faTimes, faWrench, faCogs, faCommentDots, faPhone,
  faInfoCircle, faArrowRight, faChevronLeft, faChevronRight
...
const mediaItems = [
  {
    ...
    thumbnail: 'https://www.example.com/image1-thumbnail.jpg',
  },
  {
    type: 'image',
    url: 'https://www.example.com/image2.jpg',
    thumbnail: 'https://www.example.com/image2-thumbnail.jpg',
  },
  {
    type: 'image',
    url: 'https://www.example.com/image3.jpg',
    thumbnail: 'https://www.example.com/image3-thumbnail.jpg',
  },
];
...
const MediaCarousel = () => {
  ...
  return (
    <div className="relative bg-black/5 backdrop-blur-sm rounded-2xl p-2 sm:p-4 my-8 sm:my-16 px-4 lg:px-32">
      <div className="relative aspect-video rounded-xl overflow-hidden mb-4 sm:mb-8">
      ...
      <div className="mt-2 sm:mt-4 flex gap-2 overflow-x-auto pb-2 snap-x justify-center">
        {mediaItems.map((item, index) => (
          <button
            ...
            className={`relative flex-shrink-0 rounded-lg overflow-hidden snap-center ${currentIndex === index ? 'ring-2 ring-blue-500' : ''}`}
            style={{
...
export default function Home() {
  ...
  const menuItems = [
    ...
    { href: '#testimonials', icon: faCommentDots, text: 'Testimonianze' },
    ...
    <div className="font-sans bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="#servizi"
                className="inline-flex items-center space-x-2 bg-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-blue-700 transition-colors duration-300 shadow-lg w-full sm:w-auto text-center"
              >
              ...
              <a
                ...
                className="inline-flex items-center space-x-2 bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:bg-green-600 transition-colors duration-300 shadow-lg w-full sm:w-auto text-center"
              >
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; {new Date().getFullYear()} Singer Machines - Tutti i diritti riservati</p>
        </div>
      </footer>
    </div>
  );
